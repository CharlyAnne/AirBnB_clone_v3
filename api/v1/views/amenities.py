...
def amenities():
    """function retrieves all amenities"""
...
def get_amenity(amenity_id):
    """Retrieves an amenity based on its amenity_id, return 404 if not found"""
...
def update_amenity(amenity_id: str = None):
    """function update an amenity given its id or return 404 if not found"""
    if not request.is_json:
        abort(400, "Not a JSON")
    obj = request.get_json()
    amenity = storage.get(Amenity, amenity_id)
